...
![](https://imgur.com/O1eHEft.png)

Рассмотрим интерфейс стола:

![](https://imgur.com/yUwI5Px.png)

Красным на картинке выделены слоты для ингредиентов, нужных для приготовления блюд. Все ингредиенты надо класть по одной штуке в один слот.

Жёлтым выделен слот для ножа, который нужен далеко не во всех блюдах. Нож можно скрафтить следующим образом:

![](https://imgur.com/Qu9qe1H.png)

Идём дальше. Зелёным выделен слот для топлива, которое также может быть не нужно для приготовления какого-либо блюда. В качестве топлива могут не подходить какие-либо виды топлива, поэтому лучше брать уголь, как беспроигрышный вариант.

Голубым выделен слот, являющийся индикатором приготовления блюда. Как только все что необходимо для приготовления будет распологаться в соответствующим слотах, начнется процесс приготовления. 

Как только на индикаторе будет указан незеритовый блок, в пурпурном слоте будет только что приготовленное блюдо.
